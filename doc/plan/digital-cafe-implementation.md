...
- [x] Merge the implementation branch into `main` only after verification succeeds.
...
- [x] Confirm the final `main` branch is clean and the documented commands remain accurate.
